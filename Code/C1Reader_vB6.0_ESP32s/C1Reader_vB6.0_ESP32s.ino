/***********************************************************************
* FILENAME :        C1Reader_vB6.0_ESP32s.ino          DESIGN REF: C1 Reader vB6.0
*
* DESCRIPTION :
...
*      
*
* AUTHOR :    Kyle Hagy            START DATE :    10 SEP 19
*
* CHANGES : 
*
* VERSION    DATE           WHO                 DETAIL
*   3.0     21Aug20      Kyle Hagy          Added Comments
*
*/
...
//=======================================================================
void printChipFunction(int* chipNumArray, bool chipBoolArray[], int ChipNum)
{
